...
use App\DataTables\CompteDataTable;
...
class CompteController extends AppBaseController
{
     ...
     *
     * @param CompteDataTable $compteDataTable
     * @return Response
     */
    public function index(CompteDataTable $compteDataTable)
    {
        return $compteDataTable->render('comptes.index');
    }
